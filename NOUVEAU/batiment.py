...
DictBatiments = {
    ...
    "Travail": {
        "Usine":Batiment("Usine", "Économie", 1400, +8, +8, -4, -3, 0, 3),
        "Ferme":Batiment("Ferme", "Économie", 800, +3, +2, -2, +2, +6, 2),
        "Magasin":Batiment("Magasin", "Économie", 600, +3, +2, 0, +1, 0, 1),
        "Supermarché": Batiment("Supermarché", "Économie", 1000, +5, +3, -1, +1, 0, 2),
        "Magasin_bio": Batiment("Magasin bio", "Économie", 850, +3, 0, +3, +3, 0, 3),
        "Banque": Batiment("Banque", "Économie", 1600, +6, +1, 0, -2, 0, 4),
        "Bureaux":Batiment("Bureaux", "Économie", 1100, +5, +3, -1, +1, 0, 3),
        "Marché_local": Batiment("Marché local", "Économie", 700, +2, 0, +2, +4, 0, 2),
        "Port_marchand": Batiment("Port marchand", "Économie", 2200, +10, +7, -3, 0, 0, 5)
    },
    "Environnement": {
